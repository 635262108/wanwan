...
//            return "<a href='" . $this->url(1) . "' title='首页'>首页</a>";
            return "<a href='javascript:void(0)' data-p='1' title='首页'>首页</a>";
        } else {
            return "<p>首页</p>";
        }
    }
...
//            return "<a href='" . $this->url($this->currentPage - 1) . "' title='上一页'>上一页</a>";
            ...
            return "<a href='javascript:void(0)' data-p=".$page." title='上一页'>上一页</a>";
        } else {
            return "<p>上一页</p>";
        }
    }
...
//            return "<a href='" . $this->url($this->currentPage + 1) . "' title='下一页'>下一页</a>";
            $page = $this->currentPage+1;
            return "<a href='javascript:void(0)' data-p=".$page." title='下一页'>下一页</a>";
        } else {
            return"<p>下一页</p>";
        }
    }
...
//            return "<a href='" . $this->url($this->lastPage) . "' title='尾页'>尾页</a>";
            return "<a href='javascript:void(0)' data-p=".$this->lastPage." title='尾页'>尾页</a>";
        } else {
            return "<p>尾页</p>";
        }
    }
    ...
    {
        return '<a href="javascript:void(0)" data-p='.$page.'>' . $page . '</a>';
    }
