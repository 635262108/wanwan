<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\chuangzhixing\wanwan/application/admin\view\user\attendance_detail.html";i:1512381631;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\header.html";i:1510821022;s:63:"D:\chuangzhixing\wanwan/application/admin\view\public\left.html";i:1512089528;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\footer.html";i:1512089528;}*/ ?>
<head>
	<title>玩翫碗后台管理</title>
	<meta charset="UTF-8">
...
<!--导出开始-->
 <div class="add_order">
    ...
    <select onchange="window.location=this.value" >
    	  	<option value="<?php echo url('user/attendance_detail',['aid'=>\think\Request::instance()->param('aid'),'tid'=>\think\Request::instance()->param('tid')]); ?>">查看全部</option>
    	   	<option value="<?php echo url('user/attendance_detail',['aid'=>\think\Request::instance()->param('aid'),'tid'=>\think\Request::instance()->param('tid'),'is_sign'=>1]); ?>" <?php if(\think\Request::instance()->param('is_sign') == 1): ?>selected="selected"<?php endif; ?>>已参加</option>
    	   	
    	    <option value="<?php echo url('user/attendance_detail',['aid'=>\think\Request::instance()->param('aid'),'tid'=>\think\Request::instance()->param('tid'),'is_sign'=>2]); ?>" <?php if(\think\Request::instance()->param('is_sign') == 2): ?>selected="selected"<?php endif; ?>>未参加</option>
    </select>
