<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\chuangzhixing\wanwan/application/admin\view\admin\dis_save_role.html";i:1510120048;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\header.html";i:1510111686;s:63:"D:\chuangzhixing\wanwan/application/admin\view\public\left.html";i:1510020331;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\footer.html";i:1509619838;}*/ ?>
<head>
	<title>玩翫碗后台管理</title>
	<meta charset="UTF-8">
        ...
        <div class="span6" style="margin-left: 12%;">
            <div class="widget-box" style="width: 700px;">
                ...
                <div class="widget-content nopadding">
                    <form action="<?php echo url('admin/admin/save_role'); ?>" method="post" class="form-horizontal" name="quitPay_form">
                        <input type="hidden" name="id" value="<?php echo \think\Request::instance()->param('id'); ?>"/>
                        <div class="control-group">
                            <label class="control-label">角色名：</label>
                            <div class="controls">
                                <input class="span11" name="role_name" value="<?php echo $role['role_name']; ?>" type="text">
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="checkbox" class="whole_check">全部<br>
                                ...
                                <div class="first_check" style="margin-top: 10px;">
                                <input class="first_child" type="checkbox" name="rule[]" <?php if(strpos($role['rule'],(string)$vo['id']) !== false){echo 'checked="checked"';}?> value="<?php echo $vo['id']; ?>"><?php echo $vo['node_name']; ?><br>
                               
                                <div class="second_check" style="padding-left: 3%;">
                                <?php if(is_array($node) || $node instanceof \think\Collection || $node instanceof \think\Paginator): if( count($node)==0 ) : echo "" ;else: foreach($node as $key=>$v): if($v['fid'] == $vo['id']): ?>
                                    <input type="checkbox"  <?php if(strpos($role['rule'],(string)$v['id']) !== false){echo 'checked="checked"';}?>  name="rule[]" value="<?php echo $v['id']; ?>"><?php echo $v['node_name']; endif; endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                                </div>
