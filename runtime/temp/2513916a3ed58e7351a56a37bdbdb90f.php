<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:91:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\activity\activity_ask.html";i:1508309656;s:83:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\public\header.html";i:1508309656;s:81:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\public\left.html";i:1508309656;s:83:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\public\footer.html";i:1508309656;}*/ ?>
<head>
<title>玩翫碗后台管理</title>
<meta charset="UTF-8">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody id="tbody_center" style='font-size: 12px;'>
                <?php if(is_array($askInfo) || $askInfo instanceof \think\Collection || $askInfo instanceof \think\Paginator): if( count($askInfo)==0 ) : echo "" ;else: foreach($askInfo as $key=>$vo): ?>
                <tr class="gradeX trs">
                  ...
                  <td class="center"><a href="<?php echo url('admin/activity/activity_reply_list',['rid'=>$vo['comment_id'],'aid'=>$vo['aid']]); ?>"><i class="check icon-reorder">&nbsp;&nbsp;回复</i></a>
                <i class="delete icon-pencil ask_delete">&nbsp;&nbsp;删除</i>	
                  </td>
