<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"D:\chuangzhixing\wanwan/application/admin\view\activity\dis_import_order.html";i:1509502757;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\header.html";i:1510821022;s:63:"D:\chuangzhixing\wanwan/application/admin\view\public\left.html";i:1512089528;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\footer.html";i:1512089528;}*/ ?>
<head>
	<title>玩翫碗后台管理</title>
	<meta charset="UTF-8">
                ...
                <div class="widget-content nopadding">
                    <form action="<?php echo url('admin/activity/import_user'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" name="quitPay_form">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="aid">
                                    <?php if(is_array($a_title) || $a_title instanceof \think\Collection || $a_title instanceof \think\Paginator): if( count($a_title)==0 ) : echo "" ;else: foreach($a_title as $key=>$vo): ?>
