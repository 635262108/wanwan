<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/mobile\view\activity\free_detail.html";i:1508309656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div id="theme_modal_box">
    <form method="get" action="<?php echo url('mobile/activity/activity_sure'); ?>">
        ...
        <div class="moal_div">
            ...
            <div class="activity_address activity_time">
                <p>活动时间</p >
                <ul class="select_time">
                    ...
                    <li>
                    <input type="radio" name="time" value="<?php echo $vo['t_id']; ?>" <?php if($vo['ticket_num'] == 0): ?>disabled<?php endif; ?> /><span class="sign_upTime"><?php echo $vo['t_content']; ?> 剩余 <?php echo $vo['ticket_num']; ?></span>
                    </li>
        ...
        <div class="playBaby_content almost">
            <div class="title title_img">
                ...
                <div class="playBady_word">活动详情</div>
            </div>
        </div>
        ...
        <!--玩伴评论-->
        <div class="playBaby_content almost" id="free_discuss">
            <h1>#评论</h1>
            ...
            <!--<div class="discuss_more free_more">查看更多</div>-->
        </div>
