<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\chuangzhixing\wanwan/application/mobile\view\user\order_detail.html";i:1508752767;s:66:"D:\chuangzhixing\wanwan/application/mobile\view\public\header.html";i:1508318472;s:73:"D:\chuangzhixing\wanwan/application/mobile\view\public\second_header.html";i:1508899980;}*/ ?>
<!DOCTYPE html>
<!--
            ...
            <div class="content">
                ...
                <div class="baby_detail">
                    <ul class="detail_information">
                        ...
                        <li>活动时间：<?php echo date('Y.m.d',$ActivityInfo['a_begin_time']); ?>-<?php echo date('Y.m.d',$ActivityInfo['a_begin_time']); ?></li>
                ...
                <div class="baby_detail">
                    <ul class="detail_information">
                        ...
                        支付方式：
                            <?php if($orderInfo['order_price'] == 0): ?>
                                免费活动,无需支付
                            <?php else: switch($orderInfo['pay_way']): case "0": ?>未支付<?php break; case "1": ?>支付宝<?php break; case "2": ?>微信<?php break; endswitch; endif; ?>
                        </li>
                        <li>
