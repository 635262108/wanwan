<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"D:\chuangzhixing\wanwan/application/admin\view\service\access.html";i:1512006619;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\header.html";i:1510821022;s:63:"D:\chuangzhixing\wanwan/application/admin\view\public\left.html";i:1511351498;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\footer.html";i:1511351498;}*/ ?>
<head>
	<title>玩翫碗后台管理</title>
	<meta charset="UTF-8">
...
<!--breadcrumbs-->
  <div id="content-header">
      <div id="breadcrumb"> 
      	...
      	<a href="<?php echo url('admin/service/index'); ?>" class="tip-bottom">客户中心</a>
      	<a href="#" class="current">未确定人员</a>
  </div>
  </div>
            ...
            <table class="table table-bordered data-table">
              ...
              <?php if(is_array($res) || $res instanceof \think\Collection || $res instanceof \think\Paginator): if( count($res)==0 ) : echo "" ;else: foreach($res as $key=>$vo): ?>
                <tr>
                  ...
                  <td><?php echo date('Y.m.d H:i',$vo['begin_time']); ?>--<?php echo date('m.d H:i',$vo['end_time']); ?></td>
                  <td><?php echo $vo['record']; ?></td>
                  <td>
                      <?php switch($vo['is_enter']): case "0": ?>未确认<?php break; case "1": ?>去<?php break; case "2": ?>不去<?php break; endswitch; ?>
                  </td>
                   <td class="center"> <a href="<?php echo url('admin/service/dis_save_access',['aid'=>$vo['aid'],'oid'=>$vo['order_id']]); ?>"><i class="check icon-reorder">&nbsp;&nbsp;记录</i></a>
                  </td>
                </tr>
