<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"D:\chuangzhixing\wanwan/application/admin\view\service\index.html";i:1510215380;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\header.html";i:1510821022;s:63:"D:\chuangzhixing\wanwan/application/admin\view\public\left.html";i:1512089528;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\footer.html";i:1512089528;}*/ ?>
<head>
	<title>玩翫碗后台管理</title>
	<meta charset="UTF-8">
              ...
              <tbody id="tbody_center" style="font-size: 12px;">
               <?php if(is_array($res) || $res instanceof \think\Collection || $res instanceof \think\Paginator): if( count($res)==0 ) : echo "" ;else: foreach($res as $key=>$vo): ?>
                <tr>
                  ...
                  <td class="center"> <a href="<?php echo url('admin/service/access',['aid'=>$vo['aid']]); ?>"><i class="check icon-edit" style="width: 100px;";>&nbsp;&nbsp;邀约</i></a>
                      <a href="<?php echo url('admin/service/return_visit',['aid'=>$vo['aid']]); ?>"><i class="change icon-phone" style="width: 100px;">&nbsp;&nbsp;回访</i></a>
                  </td>
                </tr>
