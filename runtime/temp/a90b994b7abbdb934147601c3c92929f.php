<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\user\add_member.html";i:1508840981;s:83:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\public\header.html";i:1508309656;s:81:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\public\left.html";i:1508834326;}*/ ?>
<!DOCTYPE html>
<html lang="en">
						...
						<div class="widget-content nopadding" style="">
							<form action="<?php echo url('admin/activity/addActivity'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" name="Alist_form" style="m-horizontal">
								<div class="control-group">
									...
									<div class="controls">
										<input class="span11" value='' name="UserName" type="text" style="width: 32%;">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">手机号</label>
									<div class="controls">
										<input class="span11" style="width: 30%;" value='' name="userTel" type="text">
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input class="span11" style="width: 30%;" value='' name="userPwd" type="password">
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<select style="width: 20%;" name="user_sex" autocomplete="off">
								...
								<div class="control-group">
									...
									<div class="controls">
										<select name="userCountry" id="seachcity" onChange="seachdistricts($(this).val())">
											...
											<option value="南阳市" selected='selected' >南阳</option>
								...
								<div class="control-group">
									...
									<div class="controls">
										<select name="userArea" id="seachdistrict">
											...
											<option value="宛城区" selected='selected' >宛城区</option>
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea class="span11" style="width: 40%;" value='' name="detailAddress"></textarea>
									</div>
								</div>
								  ...
								  <div class="control-group">
							              ...
							              <div class="controls">
							                <input type="text" value="" class="span11" name="userBirthday"/ style="width: 30%;">
