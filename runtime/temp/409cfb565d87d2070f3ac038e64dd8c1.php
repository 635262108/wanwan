<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"D:\chuangzhixing\wanwan/application/admin\view\activity\addactivitylist.html";i:1510821022;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\header.html";i:1510821022;s:63:"D:\chuangzhixing\wanwan/application/admin\view\public\left.html";i:1512089528;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\footer.html";i:1512089528;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <head>
                    ...
                    <div class="widget-content nopadding" style="">
                        <form action="<?php echo url('admin/activity/addActivity'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" name="Alist_form" style="m-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="span11" value="" placeholder="格式：2017-09-07 15:30"  name="begin_time" type="text" style="width: 30%;cursor: pointer;" onfocus="$(this).calendar()">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">活动结束时间:</label>
                                <div class="controls">
                                    <input class="span11" value="" placeholder="格式：2017-09-07 15:30"  name="end_time" type="text" style="width:30%;cursor: pointer;" onfocus="$(this).calendar()">
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select style="width: 20%;" autocomplete = "off" name="activity_type" onChange="changeActivityType($(this).val())">
                                        <option>请选择...</option>
                                    ...
                                    <select id="sonType" style="width: 20%;" name="activity_type_son">
                                        <option>请选择...</option>
                                    </select>
                                </div>
                            </div>
