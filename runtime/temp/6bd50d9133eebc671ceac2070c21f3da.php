<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:90:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\activity\addtypelist.html";i:1508309656;s:83:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\public\header.html";i:1508309656;s:81:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\public\left.html";i:1508309656;s:83:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\public\footer.html";i:1508309656;}*/ ?>
<head>
<title>玩翫碗后台管理</title>
<meta charset="UTF-8">
...
<div id="content">
        <div id="content-header">
                <div id="breadcrumb">
                        ...
                        <a href="#" class="tip-bottom">分类列表</a>
                ...
                <div class="span6" style="margin-left: 12%;">
                        <div class="widget-box" style="width: 700px;">
                                ...
                                <div class="widget-content nopadding">
                                        <form action="<?php echo url('admin/activity/addType'); ?>" method="post" class="form-horizontal" name="quitPay_form">
                                                <div class="control-group">
                                                    <label class="control-label">分类名称：</label>
                                                    <div class="controls">
                                                            <input class="span11" name="name" type="text">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                            <input class="span11" name="sort" type="text">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-actions" style="text-align: center">
                                                        ...
                                                        <a href="<?php echo url('admin/activity/activityType'); ?>" class="btn-warning">取消</a>
                                                </div>
                                                </form>
