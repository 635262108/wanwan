<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"D:\chuangzhixing\wanwan/application/admin\view\statistical\source.html";i:1509589241;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\header.html";i:1510821022;s:63:"D:\chuangzhixing\wanwan/application/admin\view\public\left.html";i:1512089528;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\footer.html";i:1512089528;}*/ ?>
<head>
	<title>玩翫碗后台管理</title>
	<meta charset="UTF-8">
...
<!--breadcrumbs-->
  <div id="content-header">
      <div id="breadcrumb"> 
      	...
      	<a href="<?php echo url('admin/user/attendance'); ?>" class="tip-bottom">统计中心</a>
      	<a href="#" class="current">来源统计</a> 
  </div>
  </div>
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody id="tbody_center" style='font-size: 12px;'>
                ...
                <tr class="gradeX trs">
                  <td class="td_id"><?php echo $vo['name']; ?></td>
                  <td><?php echo $vo['order_num']; ?></td>  
                  <td><?php echo $vo['order_sum_price']; ?></td>
                  <td><?php echo $vo['enter_num']; ?></td>
                  <td><?php echo $vo['sign_num']; ?></td>
                  <td>
                     <?php echo $vo['user_num']; ?>
                  </td>
