<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"D:\chuangzhixing\wanwan/application/admin\view\activity\order_amend.html";i:1512561569;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\header.html";i:1510821022;s:63:"D:\chuangzhixing\wanwan/application/admin\view\public\left.html";i:1512089528;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\footer.html";i:1512089528;}*/ ?>
<head>
	<title>玩翫碗后台管理</title>
	<meta charset="UTF-8">
				...
				<div class="span6" style="margin-left: 12%;">
					<div class="widget-box" style="width: 700px;">
						...
						<div class="widget-content nopadding">
							<form action="<?php echo url('admin/activity/refundOrder'); ?>" method="post" class="form-horizontal" name="quitPay_form">
								<input type='hidden' name='rid' value="<?php echo \think\Request::instance()->param('rid'); ?>"/>
