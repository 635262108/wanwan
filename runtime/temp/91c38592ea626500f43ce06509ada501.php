<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"D:\chuangzhixing\wanwan/application/admin\view\user\attendance.html";i:1512462294;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\header.html";i:1510821022;s:63:"D:\chuangzhixing\wanwan/application/admin\view\public\left.html";i:1512089528;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\footer.html";i:1512089528;}*/ ?>
<head>
	<title>玩翫碗后台管理</title>
	<meta charset="UTF-8">
...
<!--breadcrumbs-->
  <div id="content-header">
      <div id="breadcrumb"> 
      	...
      	<a href="<?php echo url('admin/user/attendance'); ?>" class="tip-bottom">客户中心</a>
      	<a href="#" class="current">签到概况</a> 
  </div>
  </div>
  
  <div class="search">
  	  <form action="" method="post">
  	  	   <input type="text" placeholder="11月26日" value="" style="cursor: pointer;" onFocus="new Calendar().show(this);"/><div class="contect"></div><input type="text" placeholder="11月30日" value="" onFocus="new Calendar().show(this);" style="cursor:pointer;"/>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody id="tbody_center" style='font-size: 12px;'>
                ...
                <tr class="gradeX trs">
                  ...
                  <td><?php echo $vo['enter_num']; ?></td>
                  <td><?php echo $vo['sign_num']; ?></td>
                  <td>
                      <?php
                            if($vo['enter_num'] == 0 || $vo['sign_num'] == 0){
                                echo '0%';
                            }else{
                  ...
                  <td>
                        <?php
                            if($vo['join_num'] == 0 || $vo['sign_num'] == 0){
                                echo '0%';
                            }else{
                                $result = floor(($vo['sign_num']/$vo['join_num'])*10000)/10000*100;
                                echo $result."%";
                            }
                      ?>
                  </td>
                  <td class="center">
                      <a href="<?php echo url('admin/user/attendance_class',['aid'=>$vo['aid']]); ?>"><i class="delete icon-pencil">&nbsp;&nbsp;详情</i></a>
                  </td>
