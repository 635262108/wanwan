<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\user\dis_add_deal.html";i:1509419889;s:83:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\public\header.html";i:1509072616;s:81:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\public\left.html";i:1509410670;s:83:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\public\footer.html";i:1509072616;}*/ ?>
<!DOCTYPE html>
<html lang="en">
				...
				<div class="span6" style="margin-left: 12%;">
					<div class="widget-box" style="width: 100%;">
						...
						<div class="widget-content nopadding" style="">
							<form action="<?php echo url('admin/user/add_deal'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" name="Alist_form" style="m-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls">
										<select name="tid" id="select_time" style="width: 42%;">
											<option value="0">请选择...</option>
                                	  ...
                                	  <div class="control-group">
							              <label class="control-label">成单金额</label>
							              <div class="controls">
							                   <input type="text" value="" class="span11" name="money" style="width: 42%;">
							              </div>
            						  </div>
								...
								<div class="control-group">
									<label class="control-label">成单描述</label>
									<div class="controls">
										<textarea class="span11" style="width: 40%;" value='' name="remark" style="width: 42%;"></textarea>
									</div>
								</div>
								...
								<div class="form-actions">
									...
									<a href="<?php echo url('admin/user/deal'); ?>" class="btn-warning">取消</a>
								</div>
