<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\chuangzhixing\wanwan/application/admin\view\service\dis_save_visit.html";i:1509067459;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\header.html";i:1510821022;s:63:"D:\chuangzhixing\wanwan/application/admin\view\public\left.html";i:1511351498;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\footer.html";i:1511351498;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <head>
    ...
    <div id="content" style="">
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="<?php echo url('admin/service/access',['aid'=>$aid]); ?>" class="tip-bottom" data-original-title="">回访记录</a>
            ...
            <div class="span6" style="margin-left: 0%;">
                <div class="widget-box" style="width: 180%;">
                    ...
                    <div class="widget-content nopadding" style="">
                        <form action="<?php echo url('admin/service/save_visit'); ?>" method="post" class="form-horizontal" name="Alist_form" style="m-horizontal">
                            <input type="hidden" name="aid" value="<?php echo $aid; ?>">
                            <input type="hidden" name="oid" value="<?php echo $oid; ?>">
                            <input type="hidden" name="tid" value="0">
                            <div class="control-group">
                                <label class="control-label">记录回访信息：</label>
                                <div class="controls">
                                    <textarea  style="width: 300px;height: 200px;" name="record"></textarea>
                                </div>
                            </div>
                            <div class="form-actions">
                                <button type="submit" class="btn btn-success info_sure">保存</button>
                                <a href="<?php echo url('admin/service/return_visit',['aid'=>$aid]); ?>" class="btn-warning">取消</a>
                            </div>
