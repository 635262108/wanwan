<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\service\index.html";i:1509072616;s:83:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\public\header.html";i:1509072616;s:81:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\public\left.html";i:1509410670;s:83:"D:\phpStudy\PHPTutorial\WWW\wanwan\wanwan/application/admin\view\public\footer.html";i:1509072616;}*/ ?>
<head>
<title>玩翫碗后台管理</title>
<meta charset="UTF-8">
...
<!--breadcrumbs-->
  <div id="content-header">
      <div id="breadcrumb"> 
      	...
      	<a href="<?php echo url('admin/service/index'); ?>" class="tip-bottom">客服中心</a>
      	<a href="#" class="current">报名情况</a> 
  </div>
  </div>
              ...
              <tbody id="tbody_center" style="font-size: 12px;">
               <?php if(is_array($res) || $res instanceof \think\Collection || $res instanceof \think\Paginator): if( count($res)==0 ) : echo "" ;else: foreach($res as $key=>$vo): ?>
                <tr>
                  ...
                  <td><?php echo $vo['enrol_num']; ?></td>
                  <td><?php echo $vo['access_num']; ?></td>
                  <td><?php echo $vo['visit_num']; ?></td>
                  <td><a href="<?php echo url('admin/service/not_go'); ?>"><?php echo $vo['not_go_num']; ?></a></td>
                  <td class="center"> <a href="<?php echo url('admin/service/access',['aid'=>$vo['aid']]); ?>"><i class="check icon-reorder" style="width: 100px;";>&nbsp;&nbsp;预约记录</i></a>
                      <a href="<?php echo url('admin/service/return_visit',['aid'=>$vo['aid']]); ?>"><i class="change icon-pencil" style="width: 100px;">&nbsp;&nbsp;回访记录</i></a>
                  </td>
                </tr>
