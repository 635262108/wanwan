<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\chuangzhixing\wanwan/application/admin\view\admin\dis_save_user.html";i:1510120048;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\header.html";i:1510111686;s:63:"D:\chuangzhixing\wanwan/application/admin\view\public\left.html";i:1510566432;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\footer.html";i:1509619838;}*/ ?>
<head>
	<title>玩翫碗后台管理</title>
	<meta charset="UTF-8">
        ...
        <div class="span6" style="margin-left: 12%;">
            <div class="widget-box" style="width: 700px;">
                ...
                <div class="widget-content nopadding">
                    <form action="<?php echo url('admin/admin/save_user'); ?>" method="post" class="form-horizontal" name="quitPay_form">
                     <input type="hidden" name="id" value="<?php echo $userInfo['id']; ?>"/>
                        <div class="control-group">
                            <label class="control-label">修改管理员：</label>
                            <div class="controls">
                                <select name="role" autocomplete = "off">
                                    ...
                                    <option value="<?php echo $vo['id']; ?>" <?php if($userInfo['role_id'] == $vo['id']): ?> selected="selected" <?php endif; ?>><?php echo $vo['role_name']; ?></option>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span11" name="name" type="text" value="<?php echo $userInfo['name']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span11" name="mobile" type="text" value="<?php echo $userInfo['mobile']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span11" name="password" type="password" style="width: 30%;"><span style="color: #C0C0C0;margin-left: 3%;">(如果不填就不修改密码)</span>
                            </div>
                        </div>
