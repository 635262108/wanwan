<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"D:\chuangzhixing\wanwan/application/admin\view\admin\dis_add_user.html";i:1509351277;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\header.html";i:1510821022;s:63:"D:\chuangzhixing\wanwan/application/admin\view\public\left.html";i:1512089528;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\footer.html";i:1512089528;}*/ ?>
<head>
	<title>玩翫碗后台管理</title>
	<meta charset="UTF-8">
        ...
        <div class="span6" style="margin-left: 12%;">
            <div class="widget-box" style="width: 700px;">
                ...
                <div class="widget-content nopadding">
                    <form action="<?php echo url('admin/admin/add_user'); ?>" method="post" class="form-horizontal" name="quitPay_form">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span11" name="mobile" type="text">
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span11" name="password" type="password">
                            </div>
                        </div>
