<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\chuangzhixing\wanwan/application/admin\view\activity\dis_add_order.html";i:1509704322;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\header.html";i:1510111686;s:63:"D:\chuangzhixing\wanwan/application/admin\view\public\left.html";i:1510020331;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\footer.html";i:1509619838;}*/ ?>
<!DOCTYPE html>
<html lang="en">
		...
		<div id="content" style="">
			<div id="content-header">
				<div id="breadcrumb">
					...
					<a href="<?php echo url('admin/activity/order'); ?>" class="tip-bottom" data-original-title="">订单中心</a>
					<a href="#" class="current">添加订单</a>
				</div>
			</div>
				...
				<div class="span6" style="margin-left: 12%;">
					<div class="widget-box" style="width: 100%;">
						...
						<div class="widget-content nopadding" style="">
							<form action="<?php echo url('admin/activity/add_order'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" name="Alist_form" style="m-horizontal">
								
								<div class="control-group">
									
									<div class="controls">
										<input type="text" value="" style="visibility: hidden;" class="uid" name="uid"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input class="span11 get_phone" style="width: 30%;" value='' name="mobile" type="text">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">姓名</label>
									<div class="controls">
										<input class="span11 get_name" style="width: 30%;" value='' name="name" type="text">
									</div>
								</div>
                                <div class="control-group">
									<label class="control-label">活动</label>
									<div class="controls">
										<select name="aid" class="select_activity" style="width: 42%;">
											...
											<option value="<?php echo $vo['aid']; ?>" price="<?php echo $vo['a_price']; ?>"><?php echo $vo['a_title']; ?></option>
								...
								<div class="control-group">
									...
									<div class="controls">
										<select name="t_id" id="select_time" style="width: 42%;">
											<option value="0">请选择...</option>
											
										</select>
										<span style="margin-left: 4%;color: #FF4134;display: none;" class="warn"></span>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input class="span11 price_num" style="width: 30%;" value='' name="order_price" type="text">
										<span style="margin-left: 5px;color: #C0C0C0 ;">(价格计算方式：小孩数量*小孩价格)</span>
									</div>
								</div>
									...
									<div class="controls">
										<input class="span11" style="width: 30%;" value='' name="child_num" type="text">
                               ...
                               <div class="control-group">
									...
									<div class="controls">
										<select name="pay_way" style="width: 42%;">
											<option value="0">请选择...</option>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<select name="source"  style="width: 42%;">
											<option value="0">请选择...</option>
								...
								<div class="form-actions">
									...
									<a href="<?php echo url('admin/activity/order'); ?>" class="btn-warning">取消</a>
								</div>
