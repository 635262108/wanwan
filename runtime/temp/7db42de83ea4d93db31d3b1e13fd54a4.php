<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"D:\chuangzhixing\wanwan/application/admin\view\activity\saveactivitylist.html";i:1512444091;s:65:"D:\chuangzhixing\wanwan/application/admin\view\public\header.html";i:1510821022;s:63:"D:\chuangzhixing\wanwan/application/admin\view\public\left.html";i:1512089528;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <head>
                    ...
                    <div class="widget-content nopadding" style="">
                        <form action="<?php echo url('admin/activity/saveActivity'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" name="Alist_form" style="m-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="span11" value="<?php echo date('Y-m-d H:i:s',$ActivityInfo['a_begin_time']); ?>"  name="begin_time" type="text" style="width: 20%" onfocus="$(this).calendar()">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">活动结束时间:</label>
                                <div class="controls">
                                    <input class="span11" value="<?php echo date('Y-m-d H:i:s',$ActivityInfo['a_end_time']); ?>"  name="end_time" type="text" style="width:20%" onfocus="$(this).calendar()">
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="span11" value='<?php echo $ActivityInfo['a_price']; ?>' style="width: 20%;margin-right: 10px;" name="price" type="text">元
