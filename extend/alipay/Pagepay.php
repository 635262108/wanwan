...
class Pagepay
{
    ...
    public static function pay($params)
    {
        ...
        // 3.获取配置
        //设置异步回调地址
        config('alipay.notify_url',"http://www.baobaowaner.com/home/Activity/alipay_notify");
        //设置支付成功回调地址
        config('alipay.return_url',"http://www.baobaowaner.com/home/Activity/pay_success/order_sn/".$params['out_trade_no']);
